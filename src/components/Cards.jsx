        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
            <div className='w-full shadow-xl flex flex-col p-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <div className=' text-center font-medium'>
                    <p className=' py-2 border-b mb-px mt-8'>1 Granted User</p>
                    <p className=' py-2 border-b mb-px'>500 GB Storage</p>
                    <p className=' py-2 border-b mb-px'>Send Up To 2 GB </p>
                </div>
